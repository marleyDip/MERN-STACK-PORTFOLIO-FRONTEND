...
const ProjectView = () => {
  ...
  useEffect(() => {
    const getProject = async () => {
      try {
        ...
        setDeployed(project.deployed || false);
        setTechnologies(project.technologies || []);
        setGitRepoLink(project.gitRepoLink || "");
        setProjectLink(project.projectLink || "");

        const bannerUrl = project.projectBanner?.url || "";

        setProjectBanner(bannerUrl);
  ...
  //     await axios
  //       .get(
  //         `https://mern-stack-portfolio-backend-8509.onrender.com/api/v1/project/get/${id}`,
  //         {
