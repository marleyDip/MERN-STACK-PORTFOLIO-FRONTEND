...
const Contact = () => {
  ...
  const handleMessage = async (e) => {
    ...
    await axios
      .post(
        "https://mern-stack-portfolio-backend-8509.onrender.com/api/v1/message/send",
    ...
    <section className="py-10" id="Contact">
      <div className="overflow-x-hidden">
        <div className="relative mb-8">
          <h1
            className="flex gap-4 items-center text-[1.5rem] sm:text-[2.5rem] md:text-[3rem] 
            lg:text-[3rem] leading-[56px] md:leading-[67px] lg:leading-[90px] 
            tracking-[15px] mx-auto w-fit font-extrabold"
            style={{
